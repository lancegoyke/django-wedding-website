...
def get_env_var(var_name):
    """Get the environment variable or return a descriptive exception."""
    try:
...
WEDDING_LOCATION = 'Lafayette, Indiana, USA'
# the date of your wedding
WEDDING_DATE = 'September 2nd, 2023'
